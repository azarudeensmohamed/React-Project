...
export const FeatureList = () => {
    ...
    useEffect(() => {
      ...
      const table = $("#table_id").DataTable({
        ...
        lengthChange: false,
        order: [[0, "desc"]],
        columnDefs: [{ targets: "_all", className: "ps-3" },
            { targets: -1, className: "text-center" }
          ],
        pagingType: window.innerWidth < 768 ? "full" : "full_numbers",
        ajax: {
          url: `${apiUrl}api/feature-list-data`,
          type: "GET",
          dataType: "json",
          beforeSend: function() {
        ...
        columns: [
          ...
          { data: "feature_logo", orderable: false },
          ...
          <div className="col-12 col-sm-10 col-bg-color-2 px-2">
            ...
            <div className="page-title-blog d-flex align-items-sm-center flex-sm-row flex-column gap-2">
              <div className="flex-grow-1">
                <h4 className="fs-18 fw-semibold mb-0">Article List</h4>
              </div>
              <div>
