        ...
        handleApiRequestGet(
            ...
            (data) => {
                if (data.status === "success") {
                    ...
                    if (data.data.blog_thumbs?.file_path) {
                        setselectedThumbPrev(data.data.blog_thumbs.file_path);
                      }

                      if (data.data.blog__mobile?.file_path) {
                        setselectedMobileprev(data.data.blog__mobile.file_path);
                      }

                      if (data.data.blog_banner?.file_path) {
                        setselectedBannerPrev(data.data.blog_banner.file_path);
                      }

                      setselectedThumb(data.data.blog_thumb);
                                            ...
                                            <div className="card">
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div className="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        {id && selectedThumbprev.length != 0 &&
                                                        <div className="image-preview-single">
                                                            <img src={apiUrl+selectedThumbprev} alt={selectedThumb} className="img-thumbnail" style={{width: '175px', height: 'auto'}} /><span onClick={() =>handleRemove(selectedThumb,'blog-thumb-preview')} className="image-remove">X</span></div>
                                                        }
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <div id="blog-mobile-preview">
                                                        {id && selectedMobileprev.length != 0 &&
                                                        <div className="image-preview-single">
                                                            <img src={apiUrl+selectedMobileprev} alt={selectedMobile} className="img-thumbnail" style={{width: '175px', height: 'auto'}} /><span onClick={() =>handleRemove(selectedMobile,'blog-mobile-preview')} className="image-remove">X</span></div>
                                                        }
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <div id="blog-banner-preview">
                                                        {id && selectedBannerprev.length != 0 &&
                                                        <div className="image-preview-single">
                                                            <img src={apiUrl+selectedBannerprev} alt={selectedBanner} className="img-thumbnail" style={{width: '175px', height: 'auto'}} /><span onClick={() =>handleRemove(selectedBanner,'blog-banner-preview')} className="image-remove">X</span></div>
                                                        }
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 col-md-6 col-12">
